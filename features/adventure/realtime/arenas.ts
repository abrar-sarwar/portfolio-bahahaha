...
// The Veiled Archer's rebuilt chamber: a compact, open 34×18 nave with two
// low ledges and no sightline-blocking pillar maze.
...
export const CATHEDRAL_ARENA: LevelDefinition = {
  ...
  decor: [
    ...
    { kind: "rain-glass", tx: 28, ty: 4 },
    { kind: "rain-chandelier", tx: 17, ty: 2 },
    { kind: "rain-bell", tx: 25, ty: 3 },
  ],
};
