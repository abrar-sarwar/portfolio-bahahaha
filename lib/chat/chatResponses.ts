...
export const CHAT_ENTRIES: ChatEntry[] = [
  ...
  },
  {
    id: "threat-intel",
    category: "cyber",
    triggers: ["threat intelligence", "threat intel", "cti", "cyber threat intelligence", "osint", "ioc", "indicators of compromise", "shinyhunters", "shiny hunters", "intel"],
    responses: [
      "threat intel is two things here: leek (an osint dossier on shinyhunters) and arkham (my briefing system). same instinct, different flavor.",
      "know your enemy. leek studies one collective; arkham briefs me on all of them.",
    ],
    links: [
  ...
  },
  {
    ...
    responses: [
      ...
      "leek. it used to be called glint. same dossier, better pun.",
    ],
    project: "leek",
    followUps: {
      why: "because shinyhunters isn't one guy, and chasing one name misses the point.",
      how: "osint, sources on everything, then detections a defender can actually use.",
      tech: "osint, sources on everything, then detections a defender can actually use.",
      "why chrollo": "he studies the ability, writes it down, then uses it. that's the whole method.",
      "why leek": "shinyhunters leaks. leek. it's a pun. i'm not sorry.",
      "why the name": "shinyhunters leaks. leek. it's a pun. i'm not sorry.",
      glint: "old name. same project. the repo still redirects.",
    },
  },
  {
    id: "counterstack",
