...
export const GALLERY_PHOTOS: GalleryPhoto[] = [
  ...
  {
    id: "liambday",
    src: `${BASE}/liambday.png`,
    width: 1120,
    height: 700,
    alt: "A large group posed shoulder to shoulder on a city street at night, several throwing peace signs.",
    title: "liam's bday",
    description: "its felt like forever since we last met up like that",
    featured: false,
    layout: { rotate: -1.4, from: "left" },
  },
  {
  ...
  {
    id: "cuddles",
    src: `${BASE}/cuddles.png`,
    width: 1166,
    height: 853,
    alt: "Two people asleep curled up together against the back of a leather couch.",
    title: "cuddles",
    description: "we had a bit too much oops",
    featured: false,
    layout: { rotate: 2.4, from: "bottom" },
  },
  {
    id: "goofypic3",
